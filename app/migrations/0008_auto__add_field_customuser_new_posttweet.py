...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.new_posttweet'
        db.add_column('app_customuser', 'new_posttweet',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.new_posttweet'
        db.delete_column('app_customuser', 'new_posttweet')
