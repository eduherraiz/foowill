...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.pub_date'
        db.alter_column('app_tweet', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'CustomUser.photo'
        db.delete_column('app_customuser', 'photo')


        # Changing field 'Tweet.pub_date'
        db.alter_column('app_tweet', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
