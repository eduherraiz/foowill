...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_tweet', 'text', self.gf('django.db.models.fields.CharField')(unique=True, max_length=140))

    def backwards(self, orm):

        # Changing field 'Tweet.text'
        db.alter_column('app_tweet', 'text', self.gf('django_fields.fields.EncryptedCharField')(max_length=293, unique=True, cipher='AES'))
