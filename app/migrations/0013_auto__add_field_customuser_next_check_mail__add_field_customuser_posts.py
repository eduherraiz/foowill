...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.next_check_mail'
        db.add_column('app_customuser', 'next_check_mail',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.posts_sended'
        db.add_column('app_customuser', 'posts_sended',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.next_check_mail'
        db.delete_column('app_customuser', 'next_check_mail')

        # Deleting field 'CustomUser.posts_sended'
        db.delete_column('app_customuser', 'posts_sended')
    ...
    models = {
        'app.customuser': {
            ...
            'next_check_mail': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'posts': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'posts_sended': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
