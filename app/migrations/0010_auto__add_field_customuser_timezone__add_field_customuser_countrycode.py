...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.timezone'
        db.add_column('app_customuser', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='Europe/Madrid', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.countrycode'
        db.add_column('app_customuser', 'countrycode',
                      self.gf('django.db.models.fields.CharField')(default='ES', max_length=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.timezone'
        db.delete_column('app_customuser', 'timezone')

        # Deleting field 'CustomUser.countrycode'
        db.delete_column('app_customuser', 'countrycode')
    ...
    models = {
        'app.customuser': {
            ...
            'countrycode': ('django.db.models.fields.CharField', [], {'default': "'ES'", 'max_length': '4', 'blank': 'True'}),
            ...
            'new_posttweet': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'publish_interval': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'timezone': ('django.db.models.fields.CharField', [], {'default': "'Europe/Madrid'", 'max_length': '128', 'blank': 'True'}),
